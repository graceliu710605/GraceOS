...
| 操作 | 文件 | 说明 |
|------|------|------|
| 🆕 | `PROJECT_OPERATING_RULES.md` | 项目运营规范（角色分工/开发流程/文档优先/自测/发布/冻结） |
| 📝 | `DEVELOPMENT_RULES.md` | 新增验收规范/文档规范/发布规范三个章节 |

### 规范要点

- **角色分工**: 产品负责人 → AI产品经理(ChatGPT) → Codex
- **开发流程**: 需求→设计→开发→自测→文档→验收→修复→发布
- **文档优先**: 禁止截图验收，ChatGPT优先阅读文档
- **证据要求**: 任何任务完成必须输出文件路径/大小/测试结果/下载链接
- **自测规范**: 每次开发完成生成 SELF_TEST_REPORT.md
- **发布标准**: 非开发人员可直接安装运行
- **冻结机制**: 发布阶段禁止新增功能
